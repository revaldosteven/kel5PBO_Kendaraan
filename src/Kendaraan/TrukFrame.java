...
public class TrukFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tKecepatanMaksimal, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/truck.png"))); // NOI18N
    ...
    private void bTampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bTampilActionPerformed
        ...
        truk.settipe(jTipe.getText());
        truk.setkapasitas_penumpang(jKapasitasPenumpang.getText());
        truk.setbahan_bakar(jBahanBakar.getText());
        truk.setkecepatan_maksimal(jKecepatanMaksimal.getText());
        truk.setfitur(jFitur.getText());
        
        tTipe.setText(""+ truk.gettipe());
        tKapasitasPenumpang.setText("" + truk.getkapasitas_penumpang());
        tBahanBakar.setText("" + truk.getbahan_bakar());
        tKecepatanMaksimal.setText("" + truk.getkecepatan_maksimal());
        tFitur.setText("" + truk.getfitur());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrukFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
