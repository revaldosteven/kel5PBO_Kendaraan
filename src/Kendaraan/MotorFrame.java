...
public class MotorFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/motorcycle (1).png"))); // NOI18N
    ...
    private void bTampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bTampilActionPerformed
        ...
        motor.settipe(jTipe.getText());
        motor.setkapasitas_penumpang(jKapasitasPenumpang.getText());
        motor.setbahan_bakar(jBahanBakar.getText());
        motor.setkecepatan_maksimal(jKecepatanMaksimal.getText());
        motor.setfitur(jFitur.getText());
        
        tTipe.setText(""+ motor.gettipe());
        tKapasitasPenumpang.setText("" + motor.getkapasitas_penumpang());
        tBahanBakar.setText("" + motor.getbahan_bakar());
        tKecepatanMaksimal.setText("" + motor.getkecepatan_maksimal());
        tFitur.setText("" + motor.getfitur());
