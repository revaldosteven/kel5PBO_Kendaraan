 ...
 * @author USER
 */
public class KapalFrame extends javax.swing.JFrame {

    /**
     * Creates new form KapalFrame
     */
    public KapalFrame() {
        initComponents();
        reset();
    ...
    private void initComponents() {
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/ship.png"))); // NOI18N
    ...
    private void bTampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bTampilActionPerformed
        ...
        kapal.settipe(jTipe.getText());
        kapal.setkapasitas_penumpang(jKapasitasPenumpang.getText());
        kapal.setbahan_bakar(jBahanBakar.getText());
        kapal.setkecepatan_maksimal(jKecepatanMaksimal.getText());
        kapal.setfitur(jFitur.getText());
        
        tTipe.setText(""+ kapal.gettipe());
        tKapasitasPenumpang.setText("" + kapal.getkapasitas_penumpang());
        tBahanBakar.setText("" + kapal.getbahan_bakar());
        tKecepatanMaksimal.setText("" + kapal.getkecepatan_maksimal());
        tFitur.setText("" + kapal.getfitur());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KapalFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KapalFrame().setVisible(true);
            }
        });
    }
