...
public class PesawatFrame extends javax.swing.JFrame {
    ...
    private void bTampilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bTampilActionPerformed
        ...
        pesawat.settipe(jTipe.getText());
        pesawat.setkapasitas_penumpang(jKapasitasPenumpang.getText());
        pesawat.setbahan_bakar(jBahanBakar.getText());
        pesawat.setkecepatan_maksimal(jKecepatanMaksimal.getText());
        pesawat.setfitur(jFitur.getText());
        
        tTipe.setText(""+ pesawat.gettipe());
        tKapasitasPenumpang.setText("" + pesawat.getkapasitas_penumpang());
        tBahanBakar.setText("" + pesawat.getbahan_bakar());
        tKecepatanMaksimal.setText("" + pesawat.getkecepatan_maksimal());
        tFitur.setText("" + pesawat.getfitur());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesawatFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
